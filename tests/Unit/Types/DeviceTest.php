...
{
    public function testDeviceDto(): void
    {
        ...
        $device = new Device($deviceId, $name, $deviceType, $state, $configuration, $actions);

        $this->assertInstanceOf(Device::class, $device);
        $this->assertSame($deviceId, $device->getDeviceId());
        $this->assertSame($name, $device->getName());
        $this->assertSame($deviceType, $device->getDeviceType());
        $this->assertSame($state, $device->getState());
        $this->assertSame($configuration, $device->getConfiguration());
        $this->assertSame($actions, $device->getActions());
    }
}
